...
class TestLargestContainer(unittest.TestCase):
    ...
    def test_two_pointers_example(self):
        self.assertEqual(largest_container_two_pointers([1,8,6,2,5,4,8,3,7]), 49)

    def test_two_pointers_empty(self):
        self.assertEqual(largest_container_two_pointers([]), 0)

    def test_two_pointers_single_element(self):
        self.assertEqual(largest_container_two_pointers([5]), 0)

    def test_two_pointers_two_elements(self):
        self.assertEqual(largest_container_two_pointers([1, 1]), 1)

    def test_two_pointers_all_same_height(self):
        self.assertEqual(largest_container_two_pointers([3,3,3,3]), 9)

    def test_two_pointers_decreasing_heights(self):
        self.assertEqual(largest_container_two_pointers([5,4,3,2,1]), 6)

    def test_two_pointers_increasing_heights(self):
        self.assertEqual(largest_container_two_pointers([1,2,3,4,5]), 6)
